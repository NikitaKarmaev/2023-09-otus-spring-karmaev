...
public class InitDB {
    ...
    public void insertGenres(GenreRepository genreRepository) {
        Genre genre1 = genreRepository.save(new Genre(null, "Comics"));
        Genre genre2 = genreRepository.save(new Genre(null, "Adventure"));
        Genre genre3 = genreRepository.save(new Genre(null, "Horror"));
